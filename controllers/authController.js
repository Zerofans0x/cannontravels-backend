...
//         httpOnly: true,
//         path: '/',
//         // Use generic ROOT_DOMAIN env variable
//         domain: (isProduction && process.env.CANNONTRAVELS_ROOT_DOMAIN) ? process.env.CANNONTRAVELS_ROOT_DOMAIN : undefined,
//         secure: isProduction,
...
//     if (redirectOverride) {
//         const frontendUrl = process.env.CANNONTRAVELS_FRONTEND_URL || 'http://localhost:3000';
...
//     if (user.isLocked()) {
//         res.status(423); throw new Error('Account locked due to excessive login attempts.');
//     }
